  ...
  const pickWinner = () => {
    ...
    setTimeout(() => {
      ...
      if (filtered.length > 0) {
        ...
        setError("No comments match your giveaway criteria!");
      }
      setIsPicking(false);
    }, 1500);
  };
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      <div className="p-6">
        ...
        {error && (
          <div className="mt-4 p-4 bg-red-50 border border-red-100 rounded-xl text-red-600 text-sm font-bold flex items-center gap-2">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-gray-600 italic mb-4">{winner.comment}</p>
